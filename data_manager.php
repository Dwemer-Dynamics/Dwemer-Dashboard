...
<head>
    ...
    <title>Playthrough Saves · Dwemer Dashboard</title>
...
<main class="sm-shell">
    <header class="sm-header">
        ...
        <div class="sm-actions"><a class="sm-button" href="index.php" target="_top">Back to Dashboard</a><button id="sm-refresh" type="button">Refresh</button></div>
    </header>
    ...
    <footer class="sm-footer">Playthrough Saves keep mod data, not game saves. Database backups are separate files.</footer>
</main>
